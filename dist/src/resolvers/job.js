...
let JobResolver = class JobResolver {
    getAllJobs() {
        return __awaiter(this, void 0, void 0, function* () {
            const jobs = yield entities_1.Job.find({});
            return { jobs };
        });
    }
    createJob(jobInput) {
        return __awaiter(this, void 0, void 0, function* () {
            return entities_1.Job.create(jobInput).save();
        });
    }
};
__decorate([
    type_graphql_1.Query(() => Jobs),
...
__decorate([
    ...
    __param(0, type_graphql_1.Arg('jobInput', () => JobInput)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [JobInput]),
    __metadata("design:returntype", Promise)
